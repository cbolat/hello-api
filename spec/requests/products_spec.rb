...
RSpec.describe 'Products API' do
  ...
  # Test suite for GET /categories/:category_id/product
  ...
  describe 'GET /categories/:category_id/products/:id' do
    before { get "/category/#{category_id}/products/#{id}" }

    context 'when category products exists' do
      it 'returns status code 200' do
        expect(response).to have_http_status(200)
      end
  ...
  describe 'PUT /categories/:category_id/categories/:id' do
